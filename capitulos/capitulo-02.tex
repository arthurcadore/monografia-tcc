...
A constelação \gls{QPSK} na \autoref{fig:qpsk_sinais_e_constelacao} é composta por quatro pontos, cada qual representando um símbolo distinto. Os símbolos são mapeados de acordo com os pares de bits \gls{dI} e \gls{dQ}. 

\section{RECEPTOR PTT-A3}

Por fim, um ruído \gls{AWGN} é adicionado ao sinal modulado \gls{st} para simular as condições reais de transmissão.  
